...
DEVICE_PORT = os.environ['DEVICE_PORT']           #"/dev/ttyS0"
BAUD = int(os.environ['BAUD'])                    #1200

SCHEDULE = os.environ['SCHEDULE']                 #'PT1M'

INFLUX_SERVER = os.environ['INFLUX_SERVER']       #'192.168.1.111'
INFLUX_PORT = int(os.environ['INFLUX_PORT'])      #8086
INFLUX_USERNAME = os.environ['INFLUX_USERNAME']   #'root'
INFLUX_PASSWORD = os.environ['INFLUX_PASSWORD']   #'root' 
INFLUX_DB = os.environ['INFLUX_DB']               #'meters'
